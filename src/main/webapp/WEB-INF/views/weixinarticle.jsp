...
<body role="document">
	<div class="weixin">
		...
		<c:forEach items="${appDownloadList}" var="appDownload">
            <hr />
		    ${appDownload.appname}<br />
			安卓版：<img src="<c:url value="${appDownload.androidqrcodeurl}" />" />
		    苹果版：<img src="<c:url value="${appDownload.iosqrcodeurl}" />" /><br />
		</c:forEach>
		<hr />
		<h4>欢迎关注<img src="<c:url value="/images/icon.png" />" />51拉钩（微信号lago51）！</h4>
		<p>51拉钩致力于全面促进家庭建设，增进家庭情感关怀，传播科学教养新知，弘扬有品质的生活态度。我们设置了“父母学堂、我爱我家、守护成长、亲子阅读、乐享生活”5个栏目，为读者们提供有深度、有价值、最干货的文章，每周一、三、五更新。</p>
	</div>
</body>
</html>